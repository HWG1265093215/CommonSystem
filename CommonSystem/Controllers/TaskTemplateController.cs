...
namespace CommonSystem.Controllers
{
    ...
    public class TaskTemplateController : BaseController
    {
        ...
        /// </summary>
        /// <returns></returns>
        [MeunAttribute(Id = Menu.TaskTemplatePageId, ParentId = Menu.SystemId, Name = "任务模板管理", Order = "9")]
        ...
        /// </summary>
        /// <returns></returns>
        [MeunAttribute(Id = Menu.TaskTemplateAddId, ParentId = Menu.TaskTemplatePageId, Name = "添加任务模板", Order = "1")]
