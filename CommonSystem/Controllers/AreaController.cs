...
namespace JuChea.Core.Web.Controllers
{
    public class AreaController : Controller
    {
        ...
        [MeunAttribute(Id = Menu.AreaPageId, ParentId = Menu.SystemId, Name = "省市区管理", Order = "2")]
        ...
        /// <returns></returns>
        [MeunAttribute(Id = Menu.AreaPageAddId, ParentId = Menu.AreaPageId, Name = "添加省市区", Order = "1")]
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [MeunAttribute(Id = Menu.AreaPageEditId, ParentId = Menu.AreaPageId, Name = "编辑省市区", Order = "2")]
        ...
        /// <returns></returns>
        [HttpPost]
        [MeunAttribute(Id = Menu.AreaPageDeleteId, ParentId = Menu.AreaPageId, Name = "删除省市区", Order = "3")]
