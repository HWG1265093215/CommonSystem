...
namespace CommonSystem.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        [MeunAttribute(Id = Menu.DepartmentPageId, ParentId = Menu.SystemId, Name = "部门管理", Order = "3")]
        ...
        /// <returns></returns>
        [MeunAttribute(Id = Menu.DepartmentAddId, ParentId = Menu.DepartmentPageId, Name = "添加部门", Order = "1")]
        ...
        /// <param name="id"></param>
        /// <returns></returns
        [MeunAttribute(Id = Menu.DepartmentEditId, ParentId = Menu.DepartmentPageId, Name = "编辑部门", Order = "2")]
        ...
        /// <returns></returns>
        [HttpPost]
        [MeunAttribute(Id = Menu.DepartmentDeleteId, ParentId = Menu.DepartmentPageId, Name = "删除部门", Order = "3")]
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        [HttpPost, IgnoreActionFilterAttribute]
