...
namespace CommonSystem.Controllers
{
    ...
    public class LogController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        [MeunAttribute(Id = Menu.LoginLogId, ParentId = Menu.LogsId, Name = "登陆日志", Order = "1")]
        ...
        /// </summary>
        /// <returns></returns>
        [MeunAttribute(Id = Menu.PageViewId, ParentId = Menu.LogsId, Name = "访问记录", Order = "2")]
        ...
        /// </summary>
        /// <returns></returns>
        [MeunAttribute(Id = Menu.ChartId, ParentId = Menu.LogsId, Name = "统计图表", Order = "3")]
